...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='VM to Assembly translator')
    parser.add_argument('input_file', help='Input .vm file or directory containing .vm files')
    parser.add_argument('-o', '--output', help='Output .asm file (optional)')
    parser.add_argument('--no-bootstrap', action='store_true', help='Skip bootstrap code')
    parser.add_argument('--no-debug', action='store_true', help='Skip debug comments')
    ...
    if os.path.isfile(args.input_file):
        # Single file - create a temporary directory structure
    ...
    try:
        translator = VMTranslator(
            programdir=input_dir,
            bootstrap=not args.no_bootstrap,
            debug=not args.no_debug,
            overwrite=args.overwrite
        )
        print(f"Successfully translated VM files in {input_dir}")
